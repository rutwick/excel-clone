(function () {
    ...
    createSheet = () => {
        ...
        if(!(rows && cols) 
            ...
            error.innerHTML = "Invalid range. Please enter numbers greater than 0.";
    ...
    createGrid = () => {
        ...
        for (let i = 0; i < rows; i++) {
            ...
            for (let j = 0; j < cols; j++) {
                ...
                //param, attrs, classList, eventHandlers, styles
    ...
    sortColumn = i => {
        ...
        sheetData[i].sort(sortAlphaNumeric);
        createGrid();
    }
